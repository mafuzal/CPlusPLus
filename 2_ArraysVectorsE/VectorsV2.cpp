...
int main()
{
	//Declare 2 epmty vectors of integers named 
	...
	cout<<"vector1 contains "<<vector1.size()<<"elemnts"<<endl;
	...
	//Now display the vector_2d values again
	cout<<"\nvector_2d:"<<endl;
	cout<<vector_2d.at(0).at(0)<<" "<<vector_2d.at(0).at(1)<<endl;
	cout<<vector_2d.at(1).at(0)<<" "<<vector_2d.at(1).at(1)<<endl;

	//Diplay the elements in vector1
	cout<<"\nvector1"<<endl;
	cout<<vector1.at(0)<<endl;
	cout<<vector1.at(1)<<endl;
